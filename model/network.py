"""
These are helper functions to calculate the CLoss described in sectio 4.2 Constraint Loss.
"""
...
def get_v(Iplus, Iminus, out):
    ...
    v, _ = torch.min((((Iplus*H)+(Iminus*(1-H)))+(1-Iplus-Iminus)) *
                     (1-Iplus*Iminus)+torch.min((Iplus*H), Iminus*(1-H))*Iplus*Iminus, dim=2)
